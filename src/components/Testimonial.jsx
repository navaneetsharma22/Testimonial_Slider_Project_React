...
const Testimonial = (props) => {
  ...
  return (
    <div className="w-[80vw] md:w-175 h-100 rounded-sm bg-white flex flex-col justify-center 
    item-center mt-10 transition-all duration-700 hover:shadow-xl  ">
      ...
      <div className="mt-6">
        <button
         onClick={surpriseHandler} className="bg-violet-400 hover:bg-violet-500 
      transition-all duration-200 cursor-pointer px-10 py-2
      rounded-md font-bold text-white text-lg w-2sx text-center mx-auto"
        >
          Surprise Me
        </button>
      </div>
